...
mkdir -p "$HOME/.codex/" "$HOME/.config/opencode/" "$HOME/.claude/" "$HOME/.gemini/" "$HOME/.pi/agent/" "$HOME/.vibe/"
...
cp AGENTS.md "$HOME/.vibe/VIBE.MD"

# Sync commands
echo "Syncing commands..."

mkdir -p "$HOME/.codex/prompts/" "$HOME/.config/opencode/commands/" "$HOME/.claude/commands/" "$HOME/.gemini/commands/" "$HOME/.pi/agent/prompts/" "$HOME/.vibe/commands/"
...
cp -r commands/* "$HOME/.vibe/commands/"
...
if [ -n "$SKILLS_DIR" ]; then
  mkdir -p "$HOME/.codex/skills/" "$HOME/.opencode/skills/" "$HOME/.claude/skills/" "$HOME/.gemini/skills/" "$HOME/.pi/agent/skills/" "$HOME/.vibe/skills/"
  ...
  cp -r "$SKILLS_DIR"/* "$HOME/.vibe/skills/"
else
